                      ...
                      <td>
                            @if (isset($data['lundi']["1"][0]))
                              <h5
                                  class="groupe"
                              >
                                  <span style="font-size: 13px">Groupe :</span> {{$data['lundi']["1"][0]->groupe->nom}}
                              </h5>
                      ...
                      >
                          @if (isset($data['lundi']["2"][0]))
                              <h5
                                  class="groupe"
                              >
                                  <span style="font-size: 13px">Groupe :</span> {{$data['lundi']["2"][0]->groupe->nom ?? ''}}
                              </h5>
                      ...
                      >
                            @if (isset($data['lundi']["3"][0]))
                              <h5
                                  class="groupe"
                              >
                                  <span style="font-size: 13px">Groupe :</span> {{$data['lundi']["3"][0]->groupe->nom ?? ''}}
                              </h5>
                      ...
                      >
                            @if (isset($data['lundi']["4"][0]))
                              <h5
                                  class="groupe"
                              >
                                  <span style="font-size: 13px">Groupe :</span> {{$data['lundi']["4"][0]->groupe->nom ?? ''}}
                              </h5>
                      ...
                      <td>
                            @if (isset($data['mardi']["1"][0]))
                              <h5
                                  class="groupe"
                              >
                                  <span style="font-size: 13px">Groupe :</span> {{$data['mardi']["1"][0]->groupe->nom ?? ''}}
                              </h5>
                                <h5
                                    class="salle"
                                >
                      ...
                      >
                            @if (isset($data['mardi']["2"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mardi']["2"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['mardi']["3"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mardi']["3"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['mardi']["4"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mardi']["4"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      <td>
                            @if (isset($data['mercredi']["1"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mercredi']["1"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['mercredi']["2"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mercredi']["2"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['mercredi']["3"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mercredi']["3"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['mercredi']["4"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['mercredi']["4"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      <td>
                            @if (isset($data['jeudi']["1"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['jeudi']["1"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['jeudi']["2"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['jeudi']["2"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['jeudi']["3"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['jeudi']["3"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['jeudi']["4"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['jeudi']["4"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      <td>
                            @if (isset($data['vendredi']["1"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['vendredi']["1"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['vendredi']["2"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['vendredi']["2"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['vendredi']["3"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['vendredi']["3"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                      ...
                      >
                            @if (isset($data['vendredi']["4"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['vendredi']["4"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                        ...
                        <td>
                            @if (isset($data['samedi']["1"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['samedi']["1"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                        ...
                        >
                            @if (isset($data['samedi']["2"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span> {{$data['samedi']["2"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                        ...
                        >
                            @if (isset($data['samedi']["3"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span>{{$data['samedi']["3"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
                        ...
                        >
                            @if (isset($data['samedi']["4"][0]))
                                <h5
                                    class="groupe"
                                >
                                    <span style="font-size: 13px">Groupe :</span>{{$data['samedi']["4"][0]->groupe->nom ?? ''}}
                                </h5>
                                    <h5
                                        class="salle"
                                    >
